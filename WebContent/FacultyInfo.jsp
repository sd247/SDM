...
<div class="main-content">
	...
	<ul>
		...
		<li><a href="GetFacultyInfo?param=${username}"> Information</a></li>
		<li><a href="Logout">Logout</a></li>

	</ul>
	<%
		if (session.getAttribute("status").equals("F")) {
			if (session != null) {
	...
	%>
	<form class="form-labels-on-top" method="post" action="GetFacultyInfo">
